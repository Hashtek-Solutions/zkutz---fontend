          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="text-center lg:text-left flex-1 space-y-4 sm:space-y-5">
                ...
                <p className="text-sm sm:text-base md:text-lg text-justify lg:text-xl font-light mt-2">
                  {feature.description}
                </p>
                <div className="space-y-2 sm:space-y-3">
                  {feature.lists.map((list, index) => (
                    <div key={index} className="flex items-start space-x-3">
                      ...
                      />
                      <p className="text-sm sm:text-base md:text-lg text-start lg:text-xl font-light">
                        {list}
                      </p>
                    </div>
                  ))}
